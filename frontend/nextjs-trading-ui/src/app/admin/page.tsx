          ...
          <table className="w-full">
            <thead className="bg-gray-800 sticky top-0">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-sm font-semibold text-gray-300">Order ID</th>
              ...
              {auditEvents.length === 0 ? (
                ...
                auditEvents.map((event, index) => (
                  <tr key={index} className="border-t border-gray-800 hover:bg-gray-800/50">
                    ...
                    <td className="px-4 py-3 text-sm text-gray-300">{event.order_id.slice(0, 8)}...</td>
                    <td className="px-4 py-3 text-sm text-white font-medium">{event.instrument}</td>
                    ...
                    <td className="px-4 py-3 text-sm text-gray-300">{event.quantity.toLocaleString()}</td>
